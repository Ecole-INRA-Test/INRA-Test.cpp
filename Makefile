...
test: test/TestRunner.cpp build-test/CoordinatesTest.o build-test/LandSensorTest.o build-test/MapTools.o build-test/RoadBookTest.o build/Land.o build/LandSensor.o build/Coordinates.o build/MapTools.o buid/RoadBook.o
...
build-test/RoadBook.o: test/RoadBookTest.cpp test/RoadBookTest.h build/RoadBook.o src/Instruction.h
